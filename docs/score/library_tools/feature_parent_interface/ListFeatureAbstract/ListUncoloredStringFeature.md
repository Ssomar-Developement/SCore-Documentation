...
# ListUncoloredStringFeature

When used, it will provide a list-type chat editor where you can add/edit/remove lines of conditions.
It makes sure that the provided string does not have color properties to prevent unwanted complications

<hr />
Target package: `com.ssomar.score.features.types.list`
<hr />

:::note
How to access the entries for the condition:  
